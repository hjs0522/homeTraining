...
{	
	...
	public static GameObject offsetNode;

	[Tooltip("prefab of offset node.")]
	public GameObject offsetNodePrefab;
...
//            jointPosition.y - offsetPos.y + kinectManager.sensorHeight,  //!! this should be better investigated .. 
    ...
    {	
		...
		if(offsetNode == null) offsetNode = Instantiate(offsetNodePrefab, GameManager.Instance.playerStartPos.position, GameManager.Instance.playerStartPos.rotation);
    }
